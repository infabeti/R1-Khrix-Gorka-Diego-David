...
public class VolcarEspaciosNaturalesTest {
	...
	EspaciosNaturales en = new EspaciosNaturales(1, "Embalse de Ullíbarri-Gamboa", "Emplazado en el municipio alavés de Arrazua-Ubarrundia, el embalse de Ull&amp;iacute...", "Pantanos", "Getxo");
